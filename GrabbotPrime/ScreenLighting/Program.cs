    ...
    class Program
    {
        ...
        private static Bridge GetBridge()
        {
            ...
            if (bridgesConfig.Contains(bridgeId))
            {
                ...
                bridge.RegisterIfNotRegistered(() => { Console.WriteLine("Application is unregistered for some unknown reason. Please press the link button."); });
            }
            else
            {
